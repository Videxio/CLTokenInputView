...
- (void)repositionViews
{
    ...
    if (self.fieldView) {
        ...
        fieldViewRect.origin.y = curY + ((STANDARD_ROW_HEIGHT - CGRectGetHeight(fieldViewRect))/2.0f);
    ...
    if (!self.fieldLabel.hidden) {
        ...
        fieldLabelRect.origin.y = curY + ((STANDARD_ROW_HEIGHT-CGRectGetHeight(fieldLabelRect))/2.0f);
    ...
    for (UIView *tokenView in self.tokenViews) {
        ...
        tokenRect.origin.y = curY + ((STANDARD_ROW_HEIGHT-CGRectGetHeight(tokenRect))/2.0f);
